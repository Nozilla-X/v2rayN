...
The Backend project is `v2rayN/v2rayN.Web/`; the Vue source is nested at `v2rayN/v2rayN.Web/WebUI/`. ServiceLib remains the shared business layer; this branch extends its TUN launch policy and scheduler cancellation hooks for the headless host. WPF/Avalonia views are unchanged. The Web workspace is intentionally a compact, profile-table-first frontend rather than a separate proxy Dashboard.
