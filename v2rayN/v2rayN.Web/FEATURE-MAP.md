...
The Backend project is `v2rayN/v2rayN.Web/`; the Vue source is nested at `v2rayN/v2rayN.Web/WebUI/`. No WPF, Avalonia, or other upstream business files were changed. The Web workspace is intentionally a compact, profile-table-first frontend rather than a separate proxy Dashboard.
